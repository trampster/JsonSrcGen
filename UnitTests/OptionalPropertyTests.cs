...
namespace UnitTests
{
    ...
    public class MyTypeConverter : ICustomConverter<MyType>
    {
        ...
        public ReadOnlySpan<char> FromJson(ReadOnlySpan<char> span, scoped ref MyType value)
        {
            value.Name = "was set";
            return span;
        }

        public ReadOnlySpan<byte> FromJson(ReadOnlySpan<byte> span, scoped ref MyType value)
        {
            value.Name = "was set";
            return span;
        }
