...
{
    public class FloatListTests : FloatListTestsBase
    {
        ...
        protected override List<float> FromJson(List<float> value, string json)
        {
            return _convert.FromJson(value, json);
        }
    }

    public class UtfFloatListTests : FloatListTestsBase
    {
        protected override string ToJson(List<float> json)
        {
    ...
    public abstract class FloatListTestsBase
    { 
        ...
        protected abstract List<float> FromJson(List<float> value, string json);
        ...
        public void FromJson_ListNull_MakesList()
        {
            //arrange
            //act
            var list = FromJson((List<float>)null, ExpectedJson);
