...
namespace JsonSrcGenTest
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            TestFromJson("FromJsonSrcGen", json => FromJsonSrcGen(testClass, json), check, ExpectedJson);
            ...
            TestToJson("ToJsonSrcGen", jsonClass => ToJsonSrcGen(jsonClass), testClass, ExpectedJson);
        ...
        static string ToJsonSrcGen(JsongTests3 testClass)
        {
            return _convert.ToJson(testClass);//Encoding.UTF8.GetString(bytes, 0, bytes.Length);
        }

        static JsongTests3 FromJsonSrcGen(JsongTests3 testClass, string jsonString)
        {
